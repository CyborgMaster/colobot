...
private:
    ...
    static CBot::CBotTypResult cClassOneInt(CBot::CBotVar* thisclass, CBot::CBotVar* &var);
    ...
    static bool rRunProgram(CBot::CBotVar* thisclass, CBot::CBotVar* var, CBot::CBotVar* result, int& exception, void* user);
